...
@section('content')
    <div class="max-w-md mx-auto px-4 py-12 text-center">
        <div class="bg-white rounded-2xl p-8 border border-slate-200">
            ...
            <p class="text-slate-400 text-sm mb-8">Suara Anda telah berhasil tercatat.</p>
            ...
            <div class="bg-teal-50 rounded-xl p-6 mb-8">
                ...
                <div class="flex items-center justify-center gap-4">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-slate-400 text-sm"><i
                                class="fa-solid fa-clock mr-1"></i>{{ $vote->created_at->format('d M Y, H:i') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                <a href="{{ route('public.index') }}"
                    class="flex-1 bg-teal-500 text-white py-3 rounded-xl font-semibold hover:bg-teal-600">
                    <i class="fa-solid fa-chart-pie mr-2"></i>Lihat Hasil
                </a>
                <form action="{{ route('siswa.logout') }}" method="POST" class="flex-1">
                    @csrf
                    <button class="w-full bg-slate-100 text-slate-700 py-3 rounded-xl font-semibold hover:bg-slate-200">
